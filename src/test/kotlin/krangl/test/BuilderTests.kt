...
class ExcelTests {
    ...
    fun `readExcel - sheet by name should match sheet by index`(){
        val nameDF = DataFrame.readExcel("src/test/resources/krangl/data/ExcelReadExample.xlsx",
                "FirstSheet")

        val indexDF = DataFrame.readExcel("src/test/resources/krangl/data/ExcelReadExample.xlsx",
                0)
    ...
    fun `readExcel - trim_ws should trim white space`(){
        val df = DataFrame.readExcel("src/test/resources/krangl/data/ExcelReadExample.xlsx",
                "FirstSheet")
        val trimmedDF = DataFrame.readExcel("src/test/resources/krangl/data/ExcelReadExample.xlsx",
                sheet = 1, trim_ws = true)
    ...
    fun `readExcel - should continue past blank line`(){
        val shouldContinueAtBlankDF = DataFrame.readExcel("src/test/resources/krangl/data/ExcelReadExample.xlsx",
